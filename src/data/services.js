export const services = [
  {
    ...
    description:
      "Update your Aadhar card details including name, address, mobile number, and photo",
    price: 150,
  ...
  },
  {
    ...
    description:
      "New Samagra ID registration or update existing details for MP government schemes",
    price: 100,
  ...
  },
  {
    ...
    description:
      "Pay your MP electricity board bills online with instant confirmation",
    price: 25,
  ...
  },
  {
    ...
    description:
      "Apply for income certificate from competent authority for various purposes",
    price: 200,
  ...
  },
  {
    ...
    description:
      "Apply for birth certificate from municipal corporation/gram panchayat",
    price: 120,
  ...
  },
  {
    ...
    description:
      "Apply for various government pension schemes (Old age, Widow, Disability)",
    price: 300,
  ...
  },
  {
    ...
    description:
      "Pay municipal water bills and get instant payment confirmation",
    price: 20,
    estimatedTime: "Instant",
    category: "Bill Payments",
    requiredDocuments: ["Latest water bill", "Consumer number"],
    instructions: [
