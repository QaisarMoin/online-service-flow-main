...
import { Plus, Trash2, GripVertical, Save, Languages } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-xs sm:text-sm text-muted-foreground font-medium">Add a new digital offering to the services portal</p>
          </div>
          ...
          <div className="lg:col-span-7">
            <Card className="rounded-2xl border-border/50 shadow-sm bg-card">
              <CardHeader className="pb-3 border-b border-border/20">
                ...
                <CardDescription className="text-xs">General details about the service</CardDescription>
              </CardHeader>
